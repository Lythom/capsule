...
**1.21.1-9.0.BUILD_ID : Port to NeoForge 1.21.1**

- Port mod from Forge 1.20.4 to NeoForge 1.21.1
- Now requires NeoForge (Forge is no longer supported from this version)
- Requires Java 21

**1.20.4-8.0.BUILD_ID : Port to Forge 1.20.4**

- Port mod to Minecraft 1.20.4
- Fix dupe bug in boat or other ContainerEntities
- Fix JEI plugin compatibility
- Fix download template feature
- Fix rendering for blocks preventing recall and linked inventory
- Update tags to check for more excluded blocks
- Update the rare castle kit
