...
public class RecoveryCapsuleFactory extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {
    /**
    ...
    public RecoveryCapsuleFactory(ItemStack inputCapsule, ItemStack inputMaterial, int targetMetadata) {
