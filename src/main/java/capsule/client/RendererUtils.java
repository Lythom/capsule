...
public class RendererUtils {
    ...
    public static void drawCube(final BlockPos pos, final float sizeOffset, final IVertexBuilder buffer) {
    ...
    public static void drawCube(final double minX, final double minY, final double minZ, final double maxX, final double maxY, final double maxZ, final IVertexBuilder buffer) {
    ...
    public static void drawPlaneNegX(final double x, final double minY, final double maxY, final double minZ, final double maxZ, final IVertexBuilder buffer) {
    ...
    public static void drawPlanePosX(final double x, final double minY, final double maxY, final double minZ, final double maxZ, final IVertexBuilder buffer) {
        buffer.vertex(x, minY, minZ).endVertex();
        buffer.vertex(x, maxY, minZ).endVertex();
        buffer.vertex(x, maxY, maxZ).endVertex();
        buffer.vertex(x, minY, maxZ).endVertex();
    ...
    public static void drawPlaneNegY(final double y, final double minX, final double maxX, final double minZ, final double maxZ, final IVertexBuilder buffer) {
    ...
    public static void drawPlanePosY(final double y, final double minX, final double maxX, final double minZ, final double maxZ, final IVertexBuilder buffer) {
        buffer.vertex(minX, y, minZ).endVertex();
        buffer.vertex(minX, y, maxZ).endVertex();
        buffer.vertex(maxX, y, maxZ).endVertex();
        buffer.vertex(maxX, y, minZ).endVertex();
    ...
    public static void drawPlaneNegZ(final double z, final double minX, final double maxX, final double minY, final double maxY, final IVertexBuilder buffer) {
    ...
    public static void drawPlanePosZ(final double z, final double minX, final double maxX, final double minY, final double maxY, final IVertexBuilder buffer) {
        buffer.vertex(minX, minY, z).endVertex();
        buffer.vertex(maxX, minY, z).endVertex();
        buffer.vertex(maxX, maxY, z).endVertex();
        buffer.vertex(minX, maxY, z).endVertex();
